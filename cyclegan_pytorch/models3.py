...
class Generator(nn.Module):
    ...
    def __init__(self, z_dim: int = 1):
        ...
        self.layers = nn.Sequential(
            ...
            nn.ConvTranspose2d(in_channels=z_dim, out_channels=64, kernel_size=5, stride=1, padding=1),
            nn.BatchNorm2d(32),
            nn.ReLU(True),
            ...
            nn.ConvTranspose2d(in_channels=128, out_channels=3, kernel_size=5, stride=1, padding=1),
            nn.Tanh()
        )
